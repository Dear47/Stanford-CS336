...
from cs336_alignment.optional_helpers import (
    compute_per_instance_dpo_loss,
    get_packed_sft_dataset as build_packed_sft_dataset,
    iterate_batches,
...
def run_tokenize_prompt_and_output(
    ...
    """
    return tokenize_and_prompt_and_output(prompt_strs, output_strs, tokenizer)
...
def run_grpo_microbatch_train_step(
    ...
    Args:
        ...
        cliprange: float | None, the clip range for the ratio. 
            Needed for loss_type="grpo_clip".
        loss_normalization: Whether to average over response tokens or divide
            each sequence sum by a constant (as in Dr. GRPO).
        normalize_constant: Constant sequence normalizer for Dr. GRPO.
...
def get_packed_sft_dataset(
    ...
    """
    return build_packed_sft_dataset(tokenizer, dataset_path, seq_length, shuffle)
