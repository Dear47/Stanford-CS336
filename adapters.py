...
def run_embedding(
    ...
    """
    from cs336_basics.transformer.module import Embedding
    try:
...
def run_swiglu(
    ...
    from cs336_basics.transformer.module import SWiGLUFFN
    try:
        swiglu = SWiGLUFFN(d_model, d_ff, device)
        swiglu.w1.weight.data = w1_weight
        swiglu.w2.weight.data = w2_weight
        swiglu.w3.weight.data = w3_weight
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.transformer.module import ScaledDotProductAttention
    try:
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.transformer.module import MultiHeadSelfAttention
    try:
        multiheadattention = MultiHeadSelfAttention(d_model,num_heads,max_seq_len=10000,theta=0.1)
        ...
        multiheadattention.QKV_proj.weight.data = qkv_proj_weight

        multiheadattention.O_proj.weight.data = o_proj_weight
        return multiheadattention(in_features,True,None)
    except:
        raise NotImplementedError
...
def run_multihead_self_attention_with_rope(
    ...
    from cs336_basics.transformer.module import MultiHeadSelfAttention
    try:
        multiheadattention = MultiHeadSelfAttention(d_model,num_heads,max_seq_len,theta)
        ...
        multiheadattention.O_proj.weight.data = o_proj_weight
        return multiheadattention(in_features,True,token_positions)
    except:
        raise NotImplementedError
...
def run_rope(
    ...
    """
    from cs336_basics.transformer.module import RoPE
    try:
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.tokenizer.trainer import train_bpe
    try:
